...
<ul class="filter-menu">
  <li class="filter-item"><a class="filter-link" href="">Boeken</a></li>
  <li class="filter-item"><a class="filter-link" href="">Boeken accessoires</a></li>
  <li class="filter-item"><a class="filter-link" href="">Agenda</a></li>
...
<ul class="shop-items">
<li class="shop-item">
<img src="assets/img/Neuromancer-small.png" alt="neuromancer-item" width="254" height="229">
<a class="price__button" href="">Neuromancer |
€12,50</a>
</li>
<li class="shop-item">
<img src="assets/img/Neuromancer-small.png" alt="neuromancer-item" width="254" height="229">
