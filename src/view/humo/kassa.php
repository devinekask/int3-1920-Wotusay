...
<span class="bold login-title">Inloggen</span>
<p class="account-maken">Hebt u nog geen profiel? <a href="" class="red">Maak een profiel aan</a></p>
<form action="get">
<div class="input__wrapper">
<label class="bold" for="email">Email-adress</label> <br>
<input class="input__login" name="email" type="email"></div>
<div class="input__wrapper">
<label class="bold" for="wachtwoord">Wachtwoord</label> <br>
